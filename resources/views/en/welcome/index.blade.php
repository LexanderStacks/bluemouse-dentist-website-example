                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-features bg-secondary pointer" style="margin-top: -70px; min-height: 190px;">
                            <div class="content pt-0">
                                ...
                                <h3>
                                    <a href="/services">MedicalDetox SPA</a>
                                </h3>
                    ...
                    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                        <div class="single-features pointer" style="margin-top: -70px; min-height: 190px;">
                            <div class="content pt-0">
                                ...
                                <h3>
                                    <a href="/services">Bio-Zahnmedizin</a>
                                </h3>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-core-features">
                            ...
                            <h3>
                                <a href="/services">Meisterlabor</a>
                            </h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-core-features">
                            ...
                            <h3>
                                <a href="/services">Barrierefreie 500m<sup>2</sup></a>
                            </h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-core-features">
                            ...
                            <h3>
                                <a href="/services">8 Praxisräume</a>
                            </h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog">
                            <div class="blog-image">
                                ...
                                <div class="tag-two"><a href="blog.html">Ganzheitliche Zahnmedizin</a></div>
                            </div>
