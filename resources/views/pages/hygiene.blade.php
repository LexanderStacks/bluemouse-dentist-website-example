      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        @foreach($posts as $post)
          <div class="accordion-item">
            ...
            <div id="flush-collapseOne-{{$loop->index}}" class="accordion-collapse collapse @if($loop->index == 0) show @endif" aria-labelledby="flush-headingOne-{{$loop->index}}" data-bs-parent="#accordionFlushExample">
