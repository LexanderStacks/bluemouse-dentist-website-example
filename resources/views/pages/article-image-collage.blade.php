        ...
        <div class="container-fluid g-0 mx-0 px-0">
            <div class="row py-5 text-center text-xl-start">
                ...
                <div id="article-image-collage-post-{{$loop->index}}-{{$post->slug}}" class="col-xl-7">
                    ...
                    <div class="bg-white shadow p-3 mt-1 mt-xl-2  mx-3 rounded rounded-3 text-black text-start" style="color: black;">
                        {!! $post->content !!}
                    </span>
                </div>
        ...
        <div class="container-fluid g-0 mx-0 px-0">
            <div class="row py-5 text-center text-xl-start">
                ...
                <div id="article-image-collage-post-{{$loop->index}}-{{$post->slug}}" class="col-xl-7">
                    ...
                    <div class="bg-white shadow p-3 mt-1 mt-xl-2 rounded rounded-3 text-start mx-3" style="color: black;">
                        {!! $post->content !!}
                    </span>
                </div>
                <div class="col-xl-1"></div>
