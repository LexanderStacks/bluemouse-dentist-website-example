		...
		<!-- Start Footer Area -->
        <footer class="footer-area pt-100 pb-70 pb-xl-0" style="background: rgb(70,70,70);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <p>Die erste ganzheitlich-biologisch orientierte Zahnarztpraxis Deutschlands.</p>
                            <div class="signature">
                                <img style="height: 1.8em;" src="/template-assets/images/footer/signature-2.png" alt="image">
                            </div>
                            ...
                            <div class="text-light mt-3">
                                <span>Für Kassen- und Privatpatienten</span>
                            </div>
                        </div>
                    </div>
<style>
...
.hover-no-underline:hover{
    color:  white;
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer-widget">
                            <h3 class="text-white">Neues & Blog</h3>
                            ...
                            <div class="footer-widget-blog">
                                <article class="item">
                                    ...
                                    <div class="info">
                                        <span>Von<a href="/doc/main" style="color:  #8eff97;">Dr. med. Hansjörg Lammers</a></span>
                                        <p><a class="text-white" href="/holistic-dentistry">Ganzheitliche Zahnmedizin</a></p>
                                    </div>
                                </article>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-information">
                                <li>
                                    <i style="color:  #8eff97;" class="flaticon-emergency-call"></i>
                                    Jetzt anrufen
                                    <span><a href="tel:02119849880">+49 211 984 988 0</a></span>
                                </li>
    
                                <li>
                                    <i style="color:  #8eff97;" class="flaticon-wall-clock"></i>
                                    Sprechzeiten wochentags
                                    <span>09:00 bis 18:00 Uhr</span>
                                </li>
                                <li>
                                    <i style="color:  #8eff97;" class="flaticon-red-cross"></i>
                                    Standort
                                    <span>Schadow-Arkaden<br>Schadowstraße 11B<br>240212 Düsseldorf</span>
                                </li>
                                <li>
                                    <img style="width: 180px; height: auto;" src="/images/jameda_rating.png">
                                </li>
                            </ul>
                        </div>
                    </div>
