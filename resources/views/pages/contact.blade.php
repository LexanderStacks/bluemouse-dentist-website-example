        ...
        <form action="/sendRequest" method="Post">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4 mt-md-0">
                    ...
                    <input style="border: none; min-height: 40px; padding-top: 42px; padding-bottom: 22px; cursor: pointer;" data-error="Dies ist ein Pflichtfeld" type="date" class="bg-white shadow no-border" name="wishDate" id="wishDate" placeholder="Ihr Wunschdatum">
