        ...
        <div class="col-lg-8 position-relative text-center text-xl-end h-100">
            <div class="row h-100 align-items-center">
                <div class="d-none d-xl-block">
                    <h2 class="text-primary bg-white px-3 py-2 shadow d-inline" style="font-size: 2.8em;">{{ $title }}</h2>
                </div>
                <div class="d-block d-xl-none">
                    <h2 class="text-primary bg-white px-3 py-2 shadow d-inline" style="font-size: 1.4em;">{{ $title }}</h2>
                </div>
            </div>
        </div>
